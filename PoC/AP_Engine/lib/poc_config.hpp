...
extern const std::vector<std::string> WEARABLES; // TODO: transform to map
...
const string AP_WEARABLE_PREFIX_KEY         = "AP_WEARABLE_PREFIX";
const string DEFAULT_WEARABLE_PREFIX        = "wb_";
const string AP_WEARABLE_COUNT_KEY          = "AP_WEARABLE_COUNT";
...
const int WEARABLES_COUNT                   = read_int_env(AP_WEARABLE_COUNT_KEY, DEFAULT_WEARABLE_COUNT);
const std::string WEARABLE_PREFIX           = read_string_env(AP_WEARABLE_PREFIX_KEY, DEFAULT_WEARABLE_PREFIX);
...
/* DEFINES */
    ...
    const std::vector<std::string> WEARABLES    = generate_robot_names(WEARABLE_PREFIX, 1, WEARABLES_COUNT);
...
const string WEARABLES_PLACEHOLDER                      = "#WEARABLE";
const string INPUT_FOLDER_FROM_WEARABLES_FEEDBACK       = string("from_wearable/") + WEARABLES_PLACEHOLDER + string("/to_ap/feedback");
